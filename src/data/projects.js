...
export const projects = [
    ...
    {
        id: 2,
        basicTitle: "Treasure Market",
        description: "Treasure is an online platform where people can collect and preserve rare and historic items, build an awesome collection, and comment on their collections and experiences.",
    ...
    },
    {
        ...
        description: "ShroomBits is a collection of cute and unique pixel mushrooms that live on the Ethereum and Matic networks.",
    ...
    },
    {
        ...
        githubUrl: "https://github.com/kazmi066/unsplash-clone",
        gradient: "gradient-5",
        category: "react",
        picture: Unsplash,
        stack: ["react", "tailwind"]

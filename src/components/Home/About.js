  ...
  return (
    <section className="mt-6 relative z-20 grid grid-cols-6 gap-6">
      <article className="sm:col-span-4 col-span-6 relative">
        ...
        <p>
          Building outstanding websites that users love! I turn ideas into seamless, user-friendly
          online experiences. With a blend of creativity and technical expertise, I focus on making
          web projects truly stand out. I currently serve as a as a{" "}
